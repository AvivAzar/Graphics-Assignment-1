...
/*void scene::loadtoShader(Shader& shader)
{
            ...
            shader.set_uniform4v(8, objectProps.size(), &objectProps[0]);
			//objects[1].x +=0.001;
}*/
        ...
        while(file.good())
        {
            ...
            switch(lineCStr[0])
            {
				...
				case 'o':
                    ...
                    objectProps.push_back(glm::vec4(0.0,0.0,0.0,0.0));
				break;
                case 'r':
                    objects.push_back(parseVec4(line));
                    objectProps.push_back(glm::vec4(1.0, 0.0, 0.0, 0.0));
                    break;
                case 't':
                    objects.push_back(parseVec4(line));
                    objectProps.push_back(glm::vec4(0.0, 1.0, 0.0, 0.0));
                    break;
				case 'c':
